...
We will explore the data from a recent [article](https://www.atsjournals.org/doi/pdf/10.1164/rccm.201712-2410OC) which explored lung cells from Pulmonary fibrosis patients by scRNAseq.
...
# Read all h5 files with Read10X_h5 function

GSE122690 <- lapply(path, Read10X_h5)
```

```{r For labeling seurat objects}
